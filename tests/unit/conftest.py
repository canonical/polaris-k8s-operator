...
@pytest.fixture
def polaris_charm():
    """Provide fixture for the polaris charm."""
    yield PolarisK8sCharm


@pytest.fixture
def polaris_context(polaris_charm):
    """Provide fixture for scenario context based on the polaris charm."""
    return Context(charm_type=polaris_charm)
...
@pytest.fixture
def polaris_container(tmp_path):
